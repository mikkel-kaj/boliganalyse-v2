...
// Mock data for now - in the future this would be generated by AI
      ...
      try {
        ...
        if (id === 'demo') {
          ...
          setProperty({
            ...
            floor: "2",
            yearBuilt: "1931",
            risks: generateRisks(null),
            highlights: generateHighlights(null)
          });
          setLoading(false);
          return;
        }
        ...
        const analyzedProperty = generateAnalysis(data.html_content, data.id);
        setProperty(analyzedProperty);
