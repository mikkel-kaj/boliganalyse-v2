...
const DetailedCommercial: React.FC = () => {
  return (
    <div className="pt-2 border-t border-border">
      <div className="bg-[#1a1b26] rounded-lg p-2 relative overflow-hidden">
        {/* Reklame banner */}
        ...
        <div className="space-y-4 p-4">
          ...
          <div className="flex items-center gap-4">
            ...
            />
            <div className="space-y-1">
              <h3 className="text-base font-semibold text-white">Mikkel Kaj Andersen</h3>
              <p className="text-sm text-blue-400">AI • Cloud • Full Stack</p>
